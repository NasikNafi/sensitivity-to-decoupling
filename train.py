...
from src.model import PPOnet, IDAACnet, APDACnet, \
...
def train(args):
    ...
    elif args.separation == 'early' or args.separation == 'late':
        actor_critic = APDACnet(
            obs_shape,
            envs.action_space.n,
    ...
    elif args.separation == 'full_daac':
